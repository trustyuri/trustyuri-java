...
public class RdfPreprocessor implements RDFHandler {
    ...
    /**
     * Preprocesses RDF content by transforming all URIs to trusty URIs, and blank nodes to URIs based on the base URI and a mapping of blank node IDs to integers.
     *
     * @param content RDF content to preprocess
     * @param baseUri base URI used
     * @param setting settings for the transformation
     * @return preprocessed RDF content
     ...
     *
     * @param content      RDF content to preprocess
     * @param artifactCode artifact code to use in the transformation
     * @return preprocessed RDF content
     * @throws TrustyUriException if the propagation fails, e.g. due to an RDFHandlerException
     */
     ...
     * Preprocesses RDF content by transforming all URIs to trusty URIs, and blank nodes to URIs based on the base URI and a mapping of blank node IDs to integers.
     *
     * @param statements RDF content to preprocess
     * @param baseUri    base URI used
     * @param setting    settings for the transformation
     * @return preprocessed RDF content
     */
